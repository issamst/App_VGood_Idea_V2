...
export class ProposeIdeaComponent implements OnInit {
  ...
  constructor(
    ...
    private AuthService :AuthService,private translate: TranslateService,private languageService: LanguageService,
